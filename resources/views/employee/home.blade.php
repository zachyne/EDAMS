...
@extends('employee.main') <!-- Make sure to extend the main layout -->
...
<div class="relative">
    ...
    <div class="absolute top-24 right-36 lg:p-2 md:p-2">
        ...
        <div>
            ...
            <a href="/employee/assessment" class=" bg-blue-500 hover:bg-blue-700 text-white font-bold my-4 py-4 px-6 rounded mt-4">
                Take Assessment
            </a>
        </div>
    </div>
